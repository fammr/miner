...
//        String conf = getConf(args);
        String conf = "/home/hjx/work/myProject/miner/minerConfig.json";
        try (FileInputStream inputStream = new FileInputStream(new File(conf))) {
    ...
    private static String getConf(String[] args) throws ParseException {
